...
export default function ThumbnailBar() {
  ...
  return (
    <div className="h-24 border-t border-[var(--border)] bg-white flex items-center gap-2 px-4 overflow-x-auto shrink-0">
      ...
      <button className="shrink-0 w-32 h-16 rounded-[8px] border-2 border-dashed border-[var(--border)] hover:border-[var(--accent)] flex items-center justify-center transition-colors cursor-pointer group">
