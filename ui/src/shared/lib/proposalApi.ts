...
export const approveProposal = (proposalId: string, acceptedIds?: string[] | null): Promise<void> =>
  api.post(`/proposals/${proposalId}/approve`, { accepted_ids: acceptedIds ?? null })
