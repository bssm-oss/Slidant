...
const PRESETS: { name: string; theme: PresentationTheme }[] = [
  ...
  { name: 'VIVID', theme: { palette: 'VIVID', bg: '#0F172A', accent: '#F43F5E', text: '#FFFFFF', text2: '#FDA4AF', font: 'Syne' } },
  { name: 'OCEAN', theme: { palette: 'OCEAN', bg: '#082F49', accent: '#0EA5E9', text: '#F0F9FF', text2: '#7DD3FC', font: 'Gmarket Sans' } },
  { name: 'GOLD', theme: { palette: 'GOLD', bg: '#18181B', accent: '#EAB308', text: '#FAFAF9', text2: '#D4D4D8', font: 'Montserrat' } },
  { name: 'SOFT', theme: { palette: 'SOFT', bg: '#FAF5FF', accent: '#D946EF', text: '#4A044E', text2: '#701A75', font: 'Pretendard' } },
  { name: 'ROSE', theme: { palette: 'ROSE', bg: '#FFF1F2', accent: '#E11D48', text: '#4C0519', text2: '#881337', font: 'Pretendard' } },
  { name: 'MIDNIGHT', theme: { palette: 'MIDNIGHT', bg: '#020617', accent: '#6366F1', text: '#F8FAFC', text2: '#CBD5E1', font: 'Inter' } },
  { name: 'FOREST', theme: { palette: 'FOREST', bg: '#052e16', accent: '#22c55e', text: '#f0fdf4', text2: '#86efac', font: 'Pretendard' } },
  { name: 'ROBOTIC', theme: { palette: 'ROBOTIC', bg: '#0f172a', accent: '#38bdf8', text: '#f8fafc', text2: '#94a3b8', font: 'Inter' } },
  { name: 'CANDY', theme: { palette: 'CANDY', bg: '#fdf2f8', accent: '#ec4899', text: '#500724', text2: '#9d174d', font: 'Syne' } },
  { name: 'EARTH', theme: { palette: 'EARTH', bg: '#451a03', accent: '#f97316', text: '#fff7ed', text2: '#fdba74', font: 'Black Han Sans' } },
]
